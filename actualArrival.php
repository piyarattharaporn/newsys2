    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Arrival List
            <small>Arrival List Today</small>
          </h1>
          <ol class="breadcrumb">
          	...
          	<div class="col-md-12">
                <div class="box">
                	<div class="box-header">
						<?php echo 
									"<strong>Arrival List </strong><br />From : " .$fromValid = date( 'd-M-Y', strtotime($from)) . 
                     ...
                     <tbody>
                   		<?php
								...
								$TotalBooking = 0;
									...
									SELECT * FROM `all_data` WHERE `REV` not like '%.%' and  `Arrival` BETWEEN '".$from."' AND'".$to." ORDER BY `Arrival` ASC'
									");
