    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Departure List
            <small>Departure List Today</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Departure List</li>
          </ol>
         </section>
         <!-- Main content -->
          	...
          	<div class="col-md-12">
                <div class="box">
                	<div class="box-header">
						<?php echo 
									"<strong>Departure List </strong><br />From : " .$fromValid = date( 'd-M-Y', strtotime($from)) . 
                     ...
                     <tbody>
                   		<?php
								...
								$TotalBooking = 0;
									...
									SELECT * FROM `all_data` WHERE `REV` not like '%.%' AND `Departure` BETWEEN '".$from."' AND'".$to." ORDER BY `Departure` ASC'
									");
