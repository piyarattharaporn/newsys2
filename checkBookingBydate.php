                            ...
                            <div class="box">
                                ...
                                <div class="box-body table-responsive">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <th colspan="2"><p align="center">Original Booking</p></th>
									...
									");
                                            while ($row = mysqli_fetch_array($result_inhouse)) {
                                                ...
                                                echo "<tr>
                                                        ...
                                                        <td><font color='#FF0000'>Check in @ " . $in = date('d-M-Y', strtotime($row['Arrival'])) . " </font></td>
                                                        <td><font color='#FF0000'>Check out @ " . $out = date('d-M-Y', strtotime($row['Departure'])) . " </font></td>
                                                </tr>";
                                    ...
                                    <table class="table-responsive" align="right">
                                        ...
                                        <tr>
                                            <th>AVG. Room rate</th>
                                            <td align="center" width="15"> : </td>
                                            <td><?php echo $Total = number_format($AVGRoomRate, 2); ?></td>
                                        </tr>
                                        <tr>
