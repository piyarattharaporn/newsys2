       ...
       <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">View Reservation Cancel Today</li>
          </ol>
        </section>
        ...
        <section class="content">
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Reservation Cancel Today</h3>
                    ...
                    <thead>
                     ...
                     <tbody>
                   		<?php
								...
								$today = date('Y-m-d');
								$result = mysqli_query($con,"SELECT * FROM `delete_data` WHERE `Date_delete` like '".$today."%' ORDER BY `id` DESC");								
								while($row = mysqli_fetch_array($result)) {
										echo"
											...
											<tr>
												...
												<td>".$row['Source']."</td>
												<td>".$row['Agent']."</td>										
												<td>".$add = date( 'd-M-Y H:i:s', strtotime($row['Date_delete']))."</td>
												<td><a href='inc/reviseBooking.php?id=".$row['id']."'> <button class ='btn btn-block btn-success btn-xs fa fa-pencil'> </button></a></td>
										  </tr>
										";
										$TotalRoom_night = $TotalRoom_night + $row['Room_night'];
										$TotalRoom_used = $TotalRoom_used + $row['Room_used'];
                        ...
                        <tr>
                            ...
                            <td><?php echo $TotalRoom_night ; ?></td>
                            <td colspan="2"></td>
                            <td><?php echo $TotalRoom_used ; ?></td>
