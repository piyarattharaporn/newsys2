       ...
       <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">View Reservation Made Today</li>
          </ol>
        </section>
        ...
        <section class="content">
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Reservation Made Today</h3>
                    ...
                    <thead>
                     ...
                     <tbody>
                   		<?php
								...
								$today = date('Y-m-d');
								$result = mysqli_query($con,"SELECT * FROM `all_data` WHERE `Date_add` like '".$today."%' ORDER BY `id` DESC");
								while($row = mysqli_fetch_array($result)) {
										echo"
											...
											<tr>
												...
												<td>".$row['Source']."</td>
												<td>".$row['Agent']."</td>										
												<td>".$add = date( 'd-M-Y H:i:s', strtotime($row['Date_add']))."</td>
